...
class BasicPublisher(MiniBusClient):
    def __init__(self, topic, schema=None):
        MiniBusClient.__init__(self)
        self.topic = topic
...
class BasicSubscriber(MiniBusClient):
    def __init__(self, topic, schema=None):
        MiniBusClient.__init__(self)
        self.counter = 0
        self.topic = topic
...
class TestMultiService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.server2 = MiniBusClient()
        self.server2.service("print_ints", {'type': 'array'}, {'type': 'string'}, self.print_ints)

        self.client1 = MiniBusClient()
        self.client2 = MiniBusClient()
